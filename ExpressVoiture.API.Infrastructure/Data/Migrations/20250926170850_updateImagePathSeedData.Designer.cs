...
namespace ExpressVoiture.Web.Data.Migrations
{
    ...
    [Migration("20250926170850_updateImagePathSeedData")]
    partial class updateImagePathSeedData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExpressVoiture.API.Domain.Models.Reparation", b =>
                {
            ...
            modelBuilder.Entity("ExpressVoiture.API.Domain.Models.Vente", b =>
                {
            ...
            modelBuilder.Entity("ExpressVoiture.API.Domain.Models.VoitureAVendre", b =>
                {
                    b.Property<int>("VoitureId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ExpressVoiture.API.Domain.Models.Reparation", b =>
                {
                    b.HasOne("ExpressVoiture.API.Domain.Models.VoitureAVendre", "Voiture")
                        .WithOne("Reparation")
                        .HasForeignKey("ExpressVoiture.API.Domain.Models.Reparation", "VoitureId")
            ...
            modelBuilder.Entity("ExpressVoiture.API.Domain.Models.Vente", b =>
                {
                    b.HasOne("ExpressVoiture.API.Domain.Models.VoitureAVendre", "Voiture")
                        .WithOne("Vente")
                        .HasForeignKey("ExpressVoiture.API.Domain.Models.Vente", "VoitureId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
